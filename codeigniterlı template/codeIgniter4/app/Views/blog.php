            ...
            <div class="container py-5">
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item">
                            <div class="blog-assets/img/">
                                <div class="blog-assets/img/-inner">
                                    <assets/img/ class="assets/img/-fluid w-100 rounded-top" src="assets/img//blog-1.jpg" alt="Image">
                                    <div class="blog-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item">
                            <div class="blog-assets/img/">
                                <div class="blog-assets/img/-inner">
                                    <assets/img/ class="assets/img/-fluid w-100 rounded-top" src="assets/img//blog-2.jpg" alt="Image">
                                    <div class="blog-icon">
                                        <a href="#" class="my-auto"><i class="fas fa-link fa-2x text-white"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item">
                            <div class="blog-assets/img/">
                                <div class="blog-assets/img/-inner">
                                    <assets/img/ class="assets/img/-fluid w-100 rounded-top" src="assets/img//blog-3.jpg" alt="Image">
                                    <div class="blog-icon">
                                        <a href="#" class="my-auto"><i class="fas fa-link fa-2x text-white"></i></a>
                                    </div>
                                </div>

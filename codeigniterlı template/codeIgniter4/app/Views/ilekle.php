    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
// ilekle sayfasında mesaj var mı kontrol et
        ...
        <div class="container">
            <div class="form-wrapper">
                <div class="form-column">
                    ...
                    <option value="0" disabled selected>Plaka Kodu Seçiniz</option>
                        <?php
                        ...
                        foreach ($plaka_il as $plaka => $il) {
                            echo "<option value='$plaka'>$plaka</option>"; // Plaka kodunu göster
                        }
                        ?>
                    </select>
...
<script>
    function updateCityName() {
        ...
        var sehir_adi = plaka_kodu !== "0" ? plaka_il[plaka_kodu] : "";
        sehir_adi_input.value = sehir_adi;
    }
</script>

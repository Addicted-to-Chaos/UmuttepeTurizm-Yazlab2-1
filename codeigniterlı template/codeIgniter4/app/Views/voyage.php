        ...
        <div class="container-fluid bg-light service py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">Seferler</h5>
                ...
                <?php foreach ($seferler as $sefer): ?>
                    ...
                    <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                                    ...
                                    <div class="service-content">
                                        ...
                                        <p class="mb-0"> Varış Şehri:<?=  $sefer['Kalkis_sehir'] ?> + Varış Şehri: <?= $sefer['Varis_sehir'] ?> + <?= $sefer['Tarih'] ?> <?= $sefer['Kalkis_saat'] ?></p><br>
                                        
                                    </div>
                                    <button  class="btn btn-primary ms-auto mt-20 me-3" style="width: 200px;" onclick="togglePanel()">Buton</button>
...
<script>
  // JavaScript ile paneli aç/kapat fonksiyonu
  function togglePanel() {
    var panel = document.getElementById("myPanel");
    if (panel.style.display === "none") {
      panel.style.display = "block"; // Paneli göster
    } else {

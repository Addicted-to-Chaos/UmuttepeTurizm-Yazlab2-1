    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4">Bizimle İletişime Geçin</h1>
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="<?= site_url('/') ?>">Ana Sayfa</a></li>
                    <li class="breadcrumb-item active text-white">İletişim</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container-fluid contact bg-light py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">İletişim</h5>
                    <h1 class="mb-0">Şikayet ve Önerileriniz İçin</h1>
                </div>
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-8">
                        <h3 class="mb-2">Bize mesaj gönderin</h3>
                        <p class="mb-4">Müşteri hizmetleri ekibimiz en kısa zamanda istek veya şikayetinize geri dönüş sağlayacaktır.</a>.</p>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">

        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    ...
                    <!-- <assets/img/ src="assets/img//logo.png" alt="Logo"> -->
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="<?= site_url('/packages') ?>" class="nav-item nav-link">Packages</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="<?= site_url('/testimonial') ?>" class="dropdown-item active">Testimonial</a>
            ...
            <div class="container py-5">
                ...
                <div class="testimonial-carousel owl-carousel">
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-assets/img/ p-1">
                            <assets/img/ src="assets/img//testimonial-1.jpg" class="assets/img/-fluid rounded-circle" alt="Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-assets/img/ p-1">
                            <assets/img/ src="assets/img//testimonial-2.jpg" class="assets/img/-fluid rounded-circle" alt="Image">
                        </div>
                        <div style="margin-top: -35px;">
                            <h5 class="mb-0">John Abraham</h5>
                            <p class="mb-0">New York, USA</p>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-assets/img/ p-1">
                            <assets/img/ src="assets/img//testimonial-3.jpg" class="assets/img/-fluid rounded-circle" alt="Image">
                        </div>
                        <div style="margin-top: -35px;">
                            <h5 class="mb-0">John Abraham</h5>
                            <p class="mb-0">New York, USA</p>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-assets/img/ p-1">
                            <assets/img/ src="assets/img//testimonial-4.jpg" class="assets/img/-fluid rounded-circle" alt="Image">
                        </div>
                        <div style="margin-top: -35px;">
                            <h5 class="mb-0">John Abraham</h5>
                            <p class="mb-0">New York, USA</p>
